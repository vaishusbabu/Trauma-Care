		    ...
		    <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <h1 style="font-size: 30px;color: gray">SEARCH Insurance Company</h1>
                                    <br>
...
if(isset($_POST['sub']))
{
    ...
    $sel=mysql_query("SELECT id,name,lattitude,longitude,address,mobile,uid, SQRT( POW(69.1 * (lattitude - $la), 2) + POW(69.1 * ($lo - longitude) * COS(lattitude / 57.3), 2)) AS distance FROM increg HAVING distance < 60 ORDER BY distance");
    $i=0;
        ...
        ?>
                                    ...
                                    <table class="table table-bordered table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <th style="color: grey" >
                                                <a href="tel:<?php echo $r[5]?>"><?php echo $r[5]?></a>
                                            </th>
                                            <th style="color: grey" >
                                                <?php echo $r[4]?>
                                            </th>
                                            <th>
                                                <a href="search_in.php?mid=<?php echo $r[6] ?>&t=1" style="text-decoration: none;display: block;width: 65px;background-color: lightgray;border-radius: 5px;padding: 5px;">View</a>
                                            </th>
                                        </tr>
...
?>
                                ...
                                <div class="col-lg-6" >
                                    ...
                                    <?php
                                        if(isset($_GET['t']))
                                        {
                                          ...
                                          {
                                              $mid=$_GET['mid'];
                                              $sel_m1=mysql_query("select * from add_inc where uid='$mid'");
                                              if($sel_m1>0)
                                                {
                           ...
                           <table class="table table-bordered table-responsive">
                                        ...
                                        <?php
                                        while($r_m1=  mysql_fetch_row($sel_m1)) 
                                        {
