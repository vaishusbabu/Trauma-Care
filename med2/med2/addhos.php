...
if(isset($_POST['sub']))
{
   ...
   $ins=  mysql_query("insert into hosreg values('','$name','$addr','$pin','$dis','$email','$land','$mob','$u','$p','$type','$lt','$lg','$ext','1')");
  $log=mysql_query("insert into user_login values('','$u','$p','hospital','1')" );
   move_uploaded_file($_FILES['photo']['tmp_name'],  getcwd()."//pic//$ext");
   if($ins>0)
   {
       header("location:addhos.php?success=1");
   }
 else {
